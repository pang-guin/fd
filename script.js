...
/* --- STEP 4 데이터 수정 --- */
const habits = [
    { icon: "🔒", text: "1. 비밀번호는 어렵게 설정하고 정기적으로 교체하기", summary: "비밀번호 관리" },
    { icon: "🚫", text: "2. SNS, 댓글 등에 개인정보 절대 공개하지 않기", summary: "SNS 신상 비공개" },
    { icon: "✂️", text: "3. 택배 송장, 영수증 등 개인정보가 담긴 종이는 꼼꼼히 파기하기", summary: "개인정보 파기" },
    { icon: "🔓", text: "4. 자동 로그인 습관은 해제하고, PC방 등에서는 반드시 로그아웃하기", summary: "로그아웃 생활화" },
    { icon: "🎁", text: "5. 과도한 정보를 요구하는 이벤트나 설문조사 참여하지 않기", summary: "과도한 정보 NO" },
    { icon: "🤫", text: "6. 소중한 개인정보는 친구에게도 함부로 알려주지 않기", summary: "비밀유지 필수" },
    { icon: "📩", text: "7. 출처를 모르는 메시지나 이메일 링크는 절대 열지 않기", summary: "의심 링크 삭제" }
];
        ...
        habits.forEach((h) => {
            ...
            grid.innerHTML += `
                <div class="mini-habit-card">
                    ...
                    <div style="font-size:0.9rem; margin-top:4px; word-break:keep-all; line-height:1.2;">
                        ${h.summary}
                    </div>
                </div>`;
        });
...
const matchData = [
    ...
    { id: 6, left: "어디에나 잠금 설정과", right: "중요한 파일에는 비밀번호 걸기" }
];
